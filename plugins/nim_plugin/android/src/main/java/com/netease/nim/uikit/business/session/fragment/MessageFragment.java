...
import com.netease.nim.uikit.business.session.actions.QuestionAction;
 ...
 */
public class MessageFragment extends TFragment implements ModuleProxy, QuestionAction.QuestionActionListener {
    ...
    private void parseIntent() {
        ...
        userInfo=JSONObject.parseObject(arguments.getString("userinfo"));
        ...
        if (!TextUtils.isEmpty(userInfo.getString("ucstate"))&&userInfo.getString("ucstate").equals("2")){
    ...
    protected List<BaseAction> getActionList() {
        ...
        actions.add(new QuestionAction(this));
