...
//        }
    ...
    for(int i=0;i<recentSessions.count;i++){
        ...
        [chatDic setObject:@(recent.unreadCount).stringValue forKey:@"unreadCount"];
...
-(void)toSelectFile{
    NSMutableDictionary * resultDic=[NSMutableDictionary dictionary];
    [resultDic setObject:@"203" forKey:@"code"];
    flutterRsult(resultDic);
}
-(void)toMetting{
    NSMutableDictionary * resultDic=[NSMutableDictionary dictionary];
       [resultDic setObject:@"204" forKey:@"code"];
       flutterRsult(resultDic);
}
-(void)toShopping{
    NSMutableDictionary * resultDic=[NSMutableDictionary dictionary];
       [resultDic setObject:@"205" forKey:@"code"];
       flutterRsult(resultDic);
}
-(void)toQuestionBank{
    NSMutableDictionary * resultDic=[NSMutableDictionary dictionary];
       [resultDic setObject:@"206" forKey:@"code"];
       flutterRsult(resultDic);
}
-(void)toAddQuestion{
    NSMutableDictionary * resultDic=[NSMutableDictionary dictionary];
        [resultDic setObject:@"207" forKey:@"code"];
        flutterRsult(resultDic);
}
-(void)toFinishCourse{
    NSMutableDictionary * resultDic=[NSMutableDictionary dictionary];
    [resultDic setObject:@"202" forKey:@"code"];
    flutterRsult(resultDic);
}
