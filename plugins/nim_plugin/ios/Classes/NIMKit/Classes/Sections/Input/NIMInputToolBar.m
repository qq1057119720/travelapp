...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_voiceButton setImage:[UIImage nim_imageInKit:@"icon_toolview_voice_normal"] forState:UIControlStateHighlighted];
        ...
        _bottomSep.backgroundColor = [UIColor whiteColor];
