...
#define  LL_StatusBarHeight (kDevice_Is_iPhoneX ? 44.f : 20.f)

#define  LL_ToTopHeight (kDevice_Is_iPhoneX ? 47.f : 27.f)

#define  LL_TopHeight (kDevice_Is_iPhoneX ? 88.f : 64.f)

#define  LL_TopNoBarHeight (kDevice_Is_iPhoneX ? 24.0f : 0.f)

#define  LL_UseHeight (LL_ScreenHeight-LL_TopHeight-LL_TabbarSafeBottomMargin)
