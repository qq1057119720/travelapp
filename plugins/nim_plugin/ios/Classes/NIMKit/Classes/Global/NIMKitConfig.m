...
{
    return @[[NIMMediaItem item:@"onTapMediaItemAsk:"
      normalImage:[UIImage nim_imageInKit:@"cp_chat_wenti"]
    selectedImage:[UIImage nim_imageInKit:@"cp_chat_wenti"]
            title:@""],
        [NIMMediaItem item:@"onTapMediaItemPicture:"
                    normalImage:[UIImage nim_imageInKit:@"bk_media_picture_normal"]
                  selectedImage:[UIImage nim_imageInKit:@"bk_media_picture_normal"]
                          title:@""],
...
- (void)applyDefaultSettings
{
    ...
    _cellBackgroundColor = NIMKit_UIColorFromRGB(0xfdfdfd);
...
- (void)applyDefaultTextSettings
{
    ...
    _textSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x000000) : NIMKit_UIColorFromRGB(0xffffff);
...
- (void)applyDefaultAudioSettings
{
    ...
    _audioSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x000000) : NIMKit_UIColorFromRGB(0xffffff);
...
- (void)applyDefaultRobotSettings
{
    ...
    _robotSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x000000) : NIMKit_UIColorFromRGB(0xffffff);
...
- (void)applyDefaultUnsupportSettings
{
    ...
    _unsupportSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x000000) : NIMKit_UIColorFromRGB(0xffffff);
...
- (void)applyDefaultNetcallNotificationSettings
{
    ...
    _netcallNotificationSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x000000) : NIMKit_UIColorFromRGB(0xffffff);
