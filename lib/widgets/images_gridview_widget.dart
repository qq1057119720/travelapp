...
import 'package:travelapp/widgets/custom_priview_imges_widget.dart';
import 'package:travelapp/widgets/my_iamge.dart';
import 'package:uuid/uuid.dart';

class ImagesGridviewWidget extends StatefulWidget {
  var changeImages;
  ImagesGridviewWidget(this.changeImages);
  @override
      ...
      onTap: (){
        println("点击图片");
         Navigator.of(context).push(PageRouteBuilder(
            pageBuilder: (c, a, s) => CustomPriviewImagesWidget(asset,
              initialPage: 0,
            )));
      },
      child: Container(
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image.asset("assets/cp_push_addimage.png"),
            ],
          ),
        ));
  }
