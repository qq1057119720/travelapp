...
//  double  _kTrackHeight = 22;
//  double  _kTrackWidth =50;
double  _kTrackHeight = 14;
double  _kTrackWidth =28;
double _kTrackRadius = _kTrackHeight / 2.0;
double _kThumbRadius = 6;
double _kSwitchWidth = _kTrackWidth - 2 * _kTrackRadius + 2 * kRadialReactionRadius;
...
class PlusSwitch extends StatefulWidget {
...
class _SwitchState extends State<PlusSwitch> with TickerProviderStateMixin {
  Map<LocalKey, ActionFactory> _actionMap;

  @override
  void initState() {
    super.initState();
    print("_kTrackHeight=="+_kTrackHeight.toString());
  ...
  Size getSwitchSize(ThemeData theme) {
    switch (widget.materialTapTargetSize ?? theme.materialTapTargetSize) {
      case MaterialTapTargetSize.padded:
        return  Size(_kSwitchWidth, _kSwitchHeight);
        break;
      case MaterialTapTargetSize.shrinkWrap:
        return  Size(_kSwitchWidth, _kSwitchHeightCollapsed);
        break;
    }
    assert(false);
    return null;
