...
//                    dispatch(CheckPhoneActionCreator.onAccountChange());
                    ...
                    GestureDetector(
                      onTap: (){
                        dispatch(RegisterActionCreator.onGetCode());
                      },
                      child: Container(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      border: OutlineInputBorder(
                                          borderRadius: BorderRadius
                                              .circular(1),
                                          borderSide: BorderSide.none)),
                                  controller: state.inviteEditController,
                                  focusNode: state.focusNodeInvite,
                                  autofocus: false,
                                  style: TextStyle(
                                      color: ColorUtil.color("333333"),
                                      fontSize: 16),
...
//                    dispatch(CheckPhoneActionCreator.onAccountChange());
                ...
                child: Container(
                  ...
                  child: Text(
                    "已有账号?前去登录",style: TextStyle(
                      fontSize: 14,color: ColorUtil.color("#4A90E2")
                  ),
                  ),
                ),
              ),
              ...
              GestureDetector(
                onTap: (){
                  dispatch(RegisterActionCreator.toRegister());
                },
                child: Container(
