...
Widget buildView(MyBalanceListState state, Dispatch dispatch, ViewService viewService) {

  Widget _buildItem(int index){
WalletLogModel walletLogModel=state.walletlist[index];
    return Container(
      ...
      child: Flex(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              walletLogModel.changemoney.toString(),
              style: TextStyle(
                  fontSize: 15,color: Colors.black,fontWeight: FontWeight.bold
              ),
            ),
